...
int main()
{
/* A program to output grade values. based upon numerical input of the user Kellie Henderson: Dr_T 8-28-2019 */
double grade = 0.0;
do
  { // begin do
  ...
  {
    cout << "\n Remember not to prioritize FUN because it will get you an F! " << endl;
  }
  } while (grade != -1);
